...
~/.local/bin/gunicorn  speasy_proxy:app --timeout 600 --max-requests 10000 --backlog 2048  --worker-connections 1000 -w 32 -k speasy_proxy.UvicornWorker.SpeasyUvicornWorker